    ...
    <div className={`nui-wrapper ${show}`} style={{ visibility: showHidden ? 'hidden' : 'visible' }}>
      ...
      <div className={`decision-wrapper ${visible}`} style={{ visibility: hidden ? 'hidden' : 'visible' }}>
        ...
        <div className='decision-button-wrapper'>
          <Button className='button' variant="contained" onClick={spawn} style={{ fontFamily: 'Roboto', background: '#37b24d' }}>Spawn</Button>
          <Button className='button' variant="contained" onClick={cancel} style={{ fontFamily: 'Roboto', background: '#f03e3e' }}>Cancel</Button>
        </div>
      </div>
      <div className='last-location'><Button color="info" style={{ width: '200px', height: '60px', fontSize: '18px', fontFamily: 'Roboto', background: '#e03131' }} variant="contained" onClick={lastLocation}>Last Location</Button></div>
